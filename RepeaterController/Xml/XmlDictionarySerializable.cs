...
namespace RepeaterController.Xml
{
    ...
    public class XmlDictionarySerializable<TKey, TValue> : IXmlSerializable
    {
        /**
         * Fields
         */
         ...
         */
        /// <summary>
        /// Converts a <see cref="XmlDictionary{TKey, TValue}"/> to a <see cref="XmlDictionarySerializable{TKey, TValue}"/>
        /// </summary>
        /// <param name="xmlDict"></param>
        public static implicit operator Dictionary<TKey, TValue>(XmlDictionarySerializable<TKey, TValue> xmlDict)
        {
        ...
        /// <summary>
        /// Converts a <see cref="Dictionary{TKey, TValue}"/> to a <see cref="XmlDictionarySerializable{TKey, TValue}"/>
        /// </summary>
        /// <param name="dict"></param>
        public static implicit operator XmlDictionarySerializable<TKey, TValue>(Dictionary<TKey, TValue> dict)
        {
            XmlDictionarySerializable<TKey, TValue> xmlDict = new XmlDictionarySerializable<TKey, TValue>(dict.Count);
         ...
         */
        /// <summary>
        /// Initializes a new instance of the <see cref="XmlDictionarySerializable{TKey, TValue}"/> class.
        /// </summary>
        public XmlDictionarySerializable()
        {
        ...
        public XmlDictionarySerializable(int capacity)
        {
            this.Items = new List<DataItem<TKey, TValue>>(capacity);
        }

        /// <summary>
        /// Removes all keys and values from the <see cref="XmlDictionarySerializable{TKey, TValue}"/>
        /// </summary>
        public void Clear()
        {
            Items.Clear();
        ...
        /// <summary>
        /// Removes the value with the specified key from the <see cref="XmlDictionarySerializable{TKey, TValue}"/>
        /// </summary>
        /// <param name="key"></param>
